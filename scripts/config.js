const config = {
  fishAddress: "0xBa4da2B396BB15012637512de8151b32e425Fe46",
  commonsAddress: "0xc53C85444Fdc84c12785A428a0Bc36F5B00499c4",
  commonsAbi: [
    ...
    { inputs: [], name: "getLastExecutedProposalId", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
    {
      inputs: [
    ...
    { inputs: [], name: "quorumDenominator", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
    ...
    { inputs: [], name: "token", outputs: [{ internalType: "contract IVotes", name: "", type: "address" }], stateMutability: "view", type: "function" },
    ...
    { inputs: [], name: "votingDelay", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "pure", type: "function" },
    { inputs: [], name: "votingPeriod", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "pure", type: "function" },
  ...
  fishAbi: [
    ...
    },
    {
      ...
      inputs: [
        ...
        { indexed: false, internalType: "uint256", name: "breedAmount", type: "uint256" },
      ],
      name: "Breed",
      type: "event",
    },
    ...
    },
    {
      ...
      inputs: [
        { indexed: false, internalType: "uint256", name: "id", type: "uint256" },
        { indexed: false, internalType: "address", name: "userAddress", type: "address" },
        { indexed: false, internalType: "uint256", name: "restockAmount", type: "uint256" },
      ],
      name: "Restock",
      type: "event",
    },
    {
      ...
      inputs: [
        { indexed: false, internalType: "uint256", name: "id", type: "uint256" },
        { indexed: false, internalType: "uint256", name: "expDate", type: "uint256" },
        { indexed: false, internalType: "uint256", name: "claimAmount", type: "uint256" },
        { indexed: false, internalType: "bool", name: "hasBred", type: "bool" },
      ],
      name: "SetProposal",
      type: "event",
    },
    ...
    { inputs: [], name: "EXP_TIME", outputs: [{ internalType: "uint8", name: "", type: "uint8" }], stateMutability: "view", type: "function" },
    { inputs: [], name: "MAX_POOL", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
    { inputs: [], name: "POOL_GROWTH", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
    {
      inputs: [
    ...
    { inputs: [], name: "breed", outputs: [], stateMutability: "nonpayable", type: "function" },
    {
      inputs: [
        { internalType: "address", name: "account", type: "address" },
    ...
    { inputs: [], name: "getGovernorAddress", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" },
    { inputs: [{ internalType: "address", name: "_address", type: "address" }], name: "getHasClaimed", outputs: [{ internalType: "bool", name: "", type: "bool" }], stateMutability: "view", type: "function" },
    ...
    { inputs: [], name: "getPool", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
    { inputs: [], name: "getProposalAmt", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
    { inputs: [], name: "getProposalBred", outputs: [{ internalType: "bool", name: "", type: "bool" }], stateMutability: "view", type: "function" },
    { inputs: [], name: "getProposalExp", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
    { inputs: [], name: "getProposalId", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
    ...
    { inputs: [{ internalType: "uint256", name: "_value", type: "uint256" }], name: "restock", outputs: [], stateMutability: "nonpayable", type: "function" },
    { inputs: [{ internalType: "address", name: "_governorAddress", type: "address" }], name: "setGovernorAddress", outputs: [], stateMutability: "nonpayable", type: "function" },
    { inputs: [{ internalType: "uint256", name: "_claimAmount", type: "uint256" }], name: "setProposal", outputs: [], stateMutability: "nonpayable", type: "function" },
